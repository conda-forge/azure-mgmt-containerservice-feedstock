About azure-mgmt-containerservice-feedstock
===========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-mgmt-containerservice-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-mgmt-containerservice-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-mgmt-containerservice
# for installing globally
pixi global install azure-mgmt-containerservice
```
...
It is possible to list all of the versions of `azure-mgmt-containerservice` available on your platform:
...
```
pixi search azure-mgmt-containerservice --channel conda-forge
```
