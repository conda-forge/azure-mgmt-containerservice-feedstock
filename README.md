About azure-mgmt-containerservice
=================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-containerservice-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9775&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-containerservice-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-containerservice` can be installed with:

```
conda install azure-mgmt-containerservice
```

It is possible to list all of the versions of `azure-mgmt-containerservice` available on your platform with:
